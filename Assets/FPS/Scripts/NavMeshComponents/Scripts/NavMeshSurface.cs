...
namespace UnityEngine.AI
{
    ...
    public class NavMeshSurface : MonoBehaviour
    {
        ...
        {
            //Debug.Log("CalculateWorldBounds()");
        ...
        {
            //Debug.Log("UpdateDataIfTransformChanged()");
